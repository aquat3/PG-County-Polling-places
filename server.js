...
app.get('/about', (req, res) => {
  ...
  const about_page_para_2 = "This application uses data provided by PG county to deliver the right experience to the PG county voter. We aim to help PG county voters plan a head by quickly locating their polling places and make their election day a breeze.";
